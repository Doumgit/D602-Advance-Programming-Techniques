# -*- coding: utf-8 -*-
"""SDoumbia_Assignment_05.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Jyh6RJeRV5IRZnSmRafNaCQByJZDaRBy
"""
...
def exercise13(n):
    ...
    dates = pd.date_range(start='1/1/2010', periods=n)    # Generating date range
...
def exercise14(words):
    ...
    words_series = pd.Series(words) #  Creating a Series from the list of words

    df = words_series.map(lambda word: len(word))
